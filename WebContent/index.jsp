...
<div class="w_100_l">
	<div class="main">
      <div class="top_banner">
        ...
        <span class="index_img"><a href="booklistt.do"><img src="Images/12.1.940x300.jpg" alt="Dan Cederholm" border="0" usemap="#Map" /></a>
        <map name="Map" id="Map">
            	...
            	<li>
                	<dl>
                        ...
                        <dt>
                            ...
                            <p class="book_inline" style="color:red;lefg-marign:5px">${book.price}</p>
	            ...
	            <table style="margin-left:35%">
	            	<tr>
	            		<td colspan="6" align="center" bgcolor="#ea4c87">共${page.totalRecords}条记录 共${page.totalPages }页 当前第${page.pageNo }页<br />
	            			<a href="<%=request.getContextPath() %>/booklist.do?pageNo=${page.topPageNo}"><input type="button" name="firstPage" value="首页"></a>
							<c:choose>
								<c:when test="${page.pageNo!=1}">
									<a href="<%=request.getContextPath() %>/booklist.do?pageNo=${page.previousPageNo}"><input type="button" name="previousPage" value="上一页"></a>
								</c:when>
								<c:otherwise>
							...
							<c:choose>
								<c:when test="${page.pageNo!=page.totalPages}">
									<a href="<%=request.getContextPath() %>/booklist.do?pageNo=${page.nextPageNo}"><input type="button" name="nextPage" value="下一页"></a>
								</c:when>
								<c:otherwise>
									<input type="button" disable="disabled" name="nextPage" value="下一页">
								</c:otherwise>
							</c:choose>	 
							<a href="<%=request.getContextPath() %>/booklist.do?pageNo=${page.bottomPageNo}"><input type="button" name="lastPage" value="尾页"></a>               			
	            		</td>
	            	</tr>	
	            </table>
      ...
      <!-- 热销书籍 -->
        <p class="index_hr"></p>
        	<div class="content">
            <h1 class="h1_book_title">热销书籍</h1>
        	<ul>
        	<c:forEach items="${bestbook}" var="book">
            	<li>
                	<dl>
                    	<dd><a href="userBuy.do"><img src="${book.imgurl}" alt="book" /></a></dd>
                        <dt>
        	...
        	<div class="press_porsen_01">
            	...
            	<dl>
                    ...
                    <dt>
                        ...
                        Welcome to my GitHub <a href="https://github.com/HappyYp" target="view_window">https://github.com/HappyYp</a>
                        </p>
                    </dt>
                </dl>
            </div>
            <div class="press_porsen_02">
            	...
            	<dl>
                    ...
                    <dt>
                        ...
                        <p class="book_intro">
                        As the madness of December comes to a close, we gathered up a few things that caught our attention during the last half of the month. <a href="#">Read on for more.</a>                        </p>
                    </dt>
                </dl>
            </div>
        </div>
